...
public class Data {
    ...
    public Connection DbCon() throws SQLException{
        ...
        try {
            ...
            URL = "jdbc:sqlite:AmeliasFarmData/Products.db";
    ...
    public Connection DbConCustomer() throws SQLException{
        ...
        try {
            ...
            URL = "jdbc:sqlite:AmeliasFarmData/Customer.db";
            con = DriverManager.getConnection(URL);
    ...
    public Connection DbConAdmin() throws SQLException{
        ...
        try {
            ...
            URL = "jdbc:sqlite:AmeliasFarmData/Admin.db";
            con = DriverManager.getConnection(URL);
    ...
    */
    ...
    public Connection DbConSales() throws SQLException{
        ...
        try {
            ...
            URL = "jdbc:sqlite:AmeliasFarmData/Sales.db";
            con = DriverManager.getConnection(URL);
    ...
    /**
     * checks if a admin has already been entered, for first time program load up
     * @return 
     */
    
    public boolean checkAdmiEntered() throws SQLException{
        ...
        try{
            ...
            DbConAdmin();
            dba = "SELECT COUNT(*) As count FROM Admin";
            ps = DbConAdmin().prepareStatement(dba);
            rs = ps.executeQuery();
    ...
    public synchronized void addToProductDatabase(String Category, Object[][] newProduct) throws SQLException{
        ...
        try{
            ...
            for(Object[] p : newProduct){
                ...
                code = p[0].toString().substring(0,3) + p[1] + p[5];
    ...
    /**
     * deletes table data then updates with new information
     * @param category 
     * @param products 
     * @throws java.sql.SQLException 
     */
